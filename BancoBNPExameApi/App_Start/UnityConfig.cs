using BancoBNPExameApi.Controllers;
...
namespace BancoBNPExameApi
{
    ...
    public static class UnityConfig
    {
        ...
        {
            var ctr = new InjectionConstructor(typeof(IMovimentoManualRepository));
            

            var container = new UnityContainer();
            //container.RegisterType<MovimentoManualsController>(ctr);
            //container.RegisterType<IController, MovimentoManualsController>("MovimentoManuals");
